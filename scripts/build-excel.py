...
def main(veri_yolu, cikti_yolu):
    ...
    kpi = [
        ...
        (f"Google Trends ölçüm tarihi", m["trendsTarih"]),
    ...
    not_satiri(ws, len(kpi) + 4, "Kaynak:",
               ...
               f"Canlı ölçümler Google Trends · {m['trendsBaslangic']} - {m['trendsTarih']}.", genislik=2)
    ...
    basliklar = ["Arama", "Kat 1", "Kat 2", "Kat 3", "Marka",
                 ...
                 f"Trends Endeksi · bu hafta · 0-100 {TR}",
                 f"Trends Değişim · son 30 gün {TR}",
                 f"Trends Değişim · geçen yıl aynı hafta {TR}",
                 "Trends Vekil Terim", "Trends Veri Gelmeyen Hafta", "E-posta Özetinde Listelendi"]
    OLCULMEDI = "-"
    satirlar = []
    for r in d["yukselenler"]:
        olculdu = r["trSimdi"] is not None
        satirlar.append([
            r["kw"], r["k1"], r["k2"], r["k3"], r["marka"], r["hacimSon"],
    ...
    sayfa_yaz(ws, basliklar, satirlar,
              [30, 18, 24, 26, 14, 20, 20, 20, 18, 18, 20, 18, 16, 14],
              delta_sutunlar={7, 9, 10}, yuzde_sutunlar={7, 9, 10})
    ...
    trends_not = (f"Trends ölçümü {olculen} başlığın tamamı için yapılmıştır. "
    ...
    terimler = [
        ...
        ("Trends Endeksi", "Google Trends'in 0-100 arası göreli arama ilgisi ölçüsü. Her başlığın kendi son 12 aylık zirvesine göredir; başlıklar arasında kıyaslanmaz."),
        ("Trends Değişim · son 30 gün", "Bu haftaki Trends değerinin, dört hafta öncesine göre yüzde değişimi."),
        ("Trends Değişim · geçen yıl aynı hafta", "Bu haftaki Trends değerinin, elli iki hafta öncesine göre yüzde değişimi."),
